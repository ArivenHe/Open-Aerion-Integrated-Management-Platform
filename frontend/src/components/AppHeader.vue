...
<template>
  <header class="h-16 flex items-center justify-between px-6 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 sticky top-0 z-30 transition-colors duration-300">
    <div class="flex items-center gap-4">
      ...
      <h2 class="text-lg font-medium text-gray-900 dark:text-white hidden md:block">Dashboard</h2>
    </div>
    ...
    <div class="flex items-center gap-3">
      ...
      <div class="relative ml-2">
        ...
        <div v-if="isUserOpen" class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-800 py-1 z-50">
            ...
            <a href="#" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800">Your Profile</a>
            <a href="#" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800">Settings</a>
            <div class="border-t border-gray-100 dark:border-gray-800 my-1"></div>
            <a href="#" class="block px-4 py-2 text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20">Sign out</a>
        </div>
      </div>
    </div>
  </header>
